                ...
                <tbody>
                    @foreach ($permissions as $permission)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('permissions.edit',['permission' => $permission->id])}}" class="btn btn-info">Editar</a>
                                <a href="{{route('permissions.show',['permission' => $permission->id])}}" class="btn btn-warning">Ver</a>
