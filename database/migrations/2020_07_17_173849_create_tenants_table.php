...
class CreateTenantsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tenants', function (Blueprint $table) {
            ...
            $table->boolean('subscription_suspended')->default(false); // Assinatura cancelada            $table->timestamps();

            $table->foreign('plan_id')->references('id')->on('plans')->onDelete('cascade');
            // onDelete =  quando deleta uma tenant também é apagado todo usuário vinculado ao tenant+
